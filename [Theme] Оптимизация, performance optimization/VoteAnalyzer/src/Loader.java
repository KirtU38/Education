...
public class Loader {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(usage / 1_000_000 + " mb");
    ...
    private static void parseFile(String fileName) throws Exception {
        ...
        NamedNodeMap voter = doc.getElementsByTagName("voter").item(0).getAttributes();
        String name = voter.getNamedItem("name").getNodeValue();
