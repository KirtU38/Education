...
public class Contains {
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("Поиск методом .contains() %n%n");
        ...
        System.out.println(input + " - рандомный номер");
    ...
    private static void generateRndNumber() {
        ...
        input = letter1st + numbers + letter2nd + letter3rd + region;
    }
